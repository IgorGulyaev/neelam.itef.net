<?php
class Mageplaza_BannerSlider_Adminhtml_BannersliderController extends Mage_Adminhtml_Controller_Action
{
    /**
     * init layout and set active for current menu
     *
     * @return Mageplaza_BannerSlider_Adminhtml_BannersliderController
     */
    ...
    public function editAction()
    {
        ...
        $model  = Mage::getModel('bannerslider/bannerslider')->load($bannersliderId);

        if ($model->getId() || $bannersliderId == 0) {
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($bannersliderIds)) {
            ...
            try {
                foreach ($bannersliderIds as $bannersliderId) {
                    Mage::getSingleton('bannerslider/bannerslider')
                        ->load($bannersliderId)
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()
                           ->createBlock('bannerslider/adminhtml_bannerslider_grid')
                           ->getCsv();
