...
class Mageplaza_BannerSlider_Block_Adminhtml_Advanceslider_Edit_Tab_Rule
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $simpleSlider=Mage::getModel('bannerslider/advanceslider')->load($id);
        $form = new Varien_Data_Form();
        $form->setHtmlIdPrefix('rule_');

        $renderer = Mage::getBlockSingleton('adminhtml/widget_form_renderer_fieldset')
            ->setTemplate('promo/fieldset.phtml')
            ->setNewChildUrl($this->getUrl('bannerslider/adminhtml_advanceslider/newConditionHtml/form/rule_conditions_fieldset'));
        ...
        Mage::dispatchEvent('bannerslider_advanceslider_edit_tab_rule_prepare_form', array(
            'form' => $form
        ));
